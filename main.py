...
w2 = Label(root, justify=LEFT, text="Smart Health Prediction System", fg="Red", bg="Ivory")
w2.config(font=("Times", 30, "bold italic"))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="Contributors: Sonal,Shakshi,Murtuza", fg="sky blue", bg="Ivory")
w2.config(font=("Times", 30, "bold italic"))
w2.grid(row=2, column=0, columnspan=2, padx=100)

# Label for the name
NameLb = Label(root, text="Name of the victim", fg="blue", bg="Ivory")
...
destreeLb = Label(root, text="RandomForest", fg="blue", bg="sky blue", width=20)
destreeLb.config(font=("Times", 15, "bold italic"))
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="NaiveBayes", fg="White", bg="red", width=20)
ranfLb.config(font=("Times", 15, "bold italic"))
ranfLb.grid(row=19, column=0, pady=10, sticky=W)

knnLb = Label(root, text="kNearestNeighbour", fg="blue", bg="Sky Blue", width=20)
...
rnf = Button(root, text="Prediction 2", command=randomforest, bg="sky blue", fg="blue")
...
rs = Button(root, text="Reset symptoms", command=Reset, bg="sky blue", fg="red", width=15)
rs.config(font=("Times", 15, "bold italic"))
rs.grid(row=10, column=3, padx=10)

ex = Button(root, text="Exit System", command=Exit, bg="sky blue", fg="red", width=15)
...
t1 = Label(root, font=("Times", 15, "bold italic"), text="Decision Tree", height=1, bg="sky blue"
           , width=40, fg="blue", textvariable=pred1, relief="sunken").grid(row=15, column=1, padx=10)

t2 = Label(root, font=("Times", 15, "bold italic"), text="Random Forest", height=1, bg="red"
...
t3 = Label(root, font=("Times", 15, "bold italic"), text="Naive Bayes", height=1, bg="sky blue"
           , width=40, fg="blue", textvariable=pred3, relief="sunken").grid(row=19, column=1, padx=10)

t4 = Label(root, font=("Times", 15, "bold italic"), text="kNearest Neighbour", height=1, bg="red"
